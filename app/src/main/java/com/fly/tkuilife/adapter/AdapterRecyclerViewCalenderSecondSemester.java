...
public class AdapterRecyclerViewCalenderSecondSemester extends RecyclerView.Adapter<AdapterRecyclerViewCalenderSecondSemester.ViewHolder> {

    private ArrayList<BeanCalendar> calendars;
    private SimpleDateFormat formator_input, formator_output;

    public AdapterRecyclerViewCalenderSecondSemester(){
